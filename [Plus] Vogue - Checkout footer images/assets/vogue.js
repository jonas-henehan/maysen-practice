...
(jquery_default()).fn.ariaExpanded = function (toggleOn) {
...
;// CONCATENATED MODULE: ./source/scripts/assets/flickityArrowIcon.js
var FLICKITY_ARROW_ICON = "M93.856 49.68c0 1.31-1.037 2.374-2.315 2.374H14.735l19.87 20.388a2.4 2.4 0 0 1 .678 1.68 2.4 2.4 0 0 1-.677 1.678 2.274 2.274 0 0 1-3.274 0L7.823 51.68a2.418 2.418 0 0 1 0-3.358L31.332 24.2a2.274 2.274 0 0 1 3.274 0 2.418 2.418 0 0 1 0 3.358L15.36 47.304h76.18c1.28 0 2.316 1.064 2.316 2.375z";
/* harmony default export */ var flickityArrowIcon = (FLICKITY_ARROW_ICON);
...
var ProductGallery = /*#__PURE__*/function () {
  ...
  ProductGallery_createClass(ProductGallery, [{
    ...
    value: function initFlickity() {
      ...
      this.flickity = new (js_default())(this.viewport, {
        pageDots: false,
        prevNextButtons: this.figures.length > 1,
        arrowShape: flickityArrowIcon,
        wrapAround: true
      });
...
var Product = /*#__PURE__*/function () {
  function Product(theme) {
    ...
    this.unitPrice = document.querySelectorAll('[data-unit-price]');
  ...
  Product_createClass(Product, [{
    ...
    value: function _generateProductGallery(el) {
      ...
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return new ProductGallery(el, Product_objectSpread({
    ...
    value: function _addProducts(products) {
      ...
      jquery_default()(products).each(function (index, el) {
        ...
        var surfacePickUpElement = el.querySelector('[data-surface-pick-up]');
        var currentProductForm = el.querySelector('[data-product-variants]');
        var _currentProductForm$d = currentProductForm.dataset,
            productTitle = _currentProductForm$d.productTitle,
            variantId = _currentProductForm$d.variantId;
        var surfacePickUp = new shopify_surface_pick_up_dist_index_es(surfacePickUpElement);
        surfacePickUp.load(variantId);
        surfacePickUp.onModalRequest(function (contents) {
          _this4.modal = new Modal({
            el: document.querySelector('[data-modal-id="surface-pick-up"]'),
            callbacks: {
              onOpen: function onOpen(_ref) {
                ...
                var variant = _this4._getSelectedProductVariant($el);

                if (productTitle && variant.title) {
                  if (variant.title === 'Default Title') {
                    modalHeader.innerHTML = "<h2 class=\"surface-pick-up-modal__header\">".concat(productTitle, "</h2>");
                  } else {
                    modalHeader.innerHTML = "<h2 class=\"surface-pick-up-modal__header\">".concat(productTitle, "</h2><span class=\"surface-pick-up-modal__subtitle\">").concat(variant.title, "</span>");
                  }
                }
          ...
          _this4.modal.showModal();
        });
        var $gallery = $el.find('.product-gallery');
        var originalGallery = $gallery[0].cloneNode(true);

        var productGallery = _this4._generateProductGallery($el[0]);

        var paymentTerms = new PaymentTerms(el); // Cache elements so we can access them quickly in the scroll handler
    ...
    value: function _bindEvents() {
      ...
      this.$body.on('change.vogue-product', '[data-option-input]', function (event) {
        return _this5._switchVariant(event);
      });
    }
    /**
    ...
    value: function _positionTick() {
      ...
      if (!this.positionTicking) {
        window.requestAnimationFrame(function () {
          _this9._updateProductPositions();

          _this9.positionTicking = false;
        });
    ...
    value: function _updateProductPositions() {
      ...
      this.products.forEach(function (product) {
        ...
        if (productRect.top < screenHeightHalf && productRect.bottom > screenHeightHalf) {
          _this10._setHistory(product);
        }

        if (_this10._isMobile() || _this10._isSingleSidebarTablet(true)) {
          ...
          product.$mobileHeader.css({
            ...
            right: _this10.gridSpacing,
            bottom: 0,
            left: _this10.gridSpacing,
            display: isInFrame ? '' : 'none'
          });
        } else if (!pinDetailsToTop && productRect.bottom - detailsHeight - _this10.gridSpacing * 2 - headerHeight < 0) {
          // Pin to bottom of the product
          product.$details.css({
            position: 'absolute',
            top: 'auto',
            left: -sidebarOffset,
            bottom: _this10.gridSpacing,
            maxHeight: height
          });
          ...
          product.$details.css({
            position: 'fixed',
            top: headerHeight + _this10.gridSpacing,
            left: _this10.gridSpacing,
            bottom: 'auto',
            maxHeight: height
          });
          ...
          product.$details.css({
            position: 'absolute',
            top: _this10.gridSpacing + topOffset,
            left: leftOffset,
            bottom: 'auto',
            maxHeight: height
          });
    ...
    value: function _updateUnitPrice(product, variant) {
      var unitPriceEl = product.querySelector('[data-unit-price]');

      if (unitPriceEl && 'unit_price_measurement' in variant) {
        var totalQuantity = unitPriceEl.querySelector('[data-total-quantity]');
        var unitPriceAmount = unitPriceEl.querySelector('[data-unit-price-amount]');
        var unitPriceMeasure = unitPriceEl.querySelector('[data-unit-price-measure]');
        ...
        if (variant.price > 0) {
          unitPriceEl.classList.remove('product-details__unit-price--hidden');
        } else {
          unitPriceEl.classList.add('product-details__unit-price--hidden');
        }
      } else if (unitPriceEl) {
        unitPriceEl.classList.add('product-details__unit-price--hidden');
      }
    ...
    value: function _switchVariant(event) {
      ...
      this._updatePrice($product, variant);

      var _this$products$filter = this.products.filter(function (_ref2) {
        var $el = _ref2.$el;
        return $el[0] === $product[0];
      })[0],
          paymentTerms = _this$products$filter.paymentTerms,
          surfacePickUp = _this$products$filter.surfacePickUp;
      paymentTerms.update(variant.id);
      surfacePickUp.load(variant.id);
    }
  }, {
    ...
    value: function _updateProductVariant($product, variant) {
      ...
      $product.find('[data-product-variants]').val(variant.id); // Focus on variant image

      this._selectVariantImage($product, variant);
    }
  }, {
    key: "_updatePrice",
    value: function _updatePrice($product, variant) {
      var hasCompareAtPrice = variant.compare_at_price !== null && variant.compare_at_price > variant.price;
      var $productPrice = $product.find('[data-price-original]');
      var $compareAtPrice = $product.find('[data-price-compare]');
      $productPrice.text(Shopify.formatMoney(variant.price, window.Theme.moneyFormat));
      $compareAtPrice.text(Shopify.formatMoney(variant.compare_at_price, window.Theme.moneyFormat)).toggleClass('product-price-has-compare', hasCompareAtPrice);

      this._updateUnitPrice($product[0], variant);
    }
  }, {
  ...
  ThemeEditor_createClass(_default, [{
    ...
    value: function _product(section, load) {
      if (jquery_default()(section).attr('id') === 'shopify-section-page-product') {
        if (load) {
          this.theme.product = new Product(this.theme);
        } else {
...
var dist = __webpack_require__(529);
var dist_default = /*#__PURE__*/__webpack_require__.n(dist);
// EXTERNAL MODULE: ./node_modules/@vimeo/player/dist/player.js
var dist_player = __webpack_require__(150);
...
var HomeSlideshow = /*#__PURE__*/function () {
  ...
  HomeSlideshow_createClass(HomeSlideshow, [{
    ...
    value: function _initFlickity() {
      this.flickity = new (js_default())(this.$slideshow[0], {
        accessibility: true,
        adaptiveHeight: true,
    ...
    value: function _initVimeo(slideId, videoId, parentSlide) {
      ...
      var player = new (player_default())(slideId, options);
      player.setVolume(0);
...
var HomeTestimonials = /*#__PURE__*/function () {
...
var twitterFetcher_min = __webpack_require__(579);
...
var HomeTwitter = /*#__PURE__*/function () {
  ...
  function HomeMap(section) {
    ...
    if (this.apiKey) {
      if (window.googleMaps === undefined) {
        ...
        jquery_default().getScript("https://maps.googleapis.com/maps/api/js?key=".concat(this.apiKey)).done(function () {
...
var ProductRecommendations = /*#__PURE__*/function () {
  ...
  ProductRecommendations_createClass(ProductRecommendations, [{
    ...
    value: function _loadRecommendations() {
      ...
      var recommendUrl = "".concat(window.Theme.routes.product_recommendations_url, "?section_id=product-recommendations&limit=").concat(this.limit, "&product_id=").concat(this.productId);
...
var Cart = /*#__PURE__*/function () {
  ...
  Cart_createClass(Cart, [{
    ...
    value: function _calculateShipping() {
      ...
      jquery_default().ajax("/cart/shipping_rates.json?".concat(queryString), {
        dataType: 'json'
      }).fail(function (error) {
        ...
        jquery_default()('.wrapper-response', _this5.el).empty().append("<p class='shipping-calculator-response message'/><ul class='shipping-rates'/>");
        var ratesFeedback = jquery_default()('.shipping-calculator-response', _this5.el);
        ...
        var $cartShippingRates = jquery_default()('.cart-shipping-rates', _this5.el);
        $cartShippingRates.empty();
        ...
        for (var i = 0; i < rates.length; i++) {
          ...
          $cartShippingRates.append("<li>".concat(rateValues, "</li>")); // Reset the calculating button so it can be used again
    ...
    value: function _handleErrors(errors) {
      var errorMessage = jquery_default().parseJSON(errors.responseText);
...
var Home = /*#__PURE__*/function () {
  function Home() {
    ...
    this._init(); // Check browser type, add browser type to body
...
var StaticLookbook = /*#__PURE__*/function () {
  ...
  StaticLookbook_createClass(StaticLookbook, [{
    ...
    value: function _initSlideShows() {
      ...
      var arrowShape = flickityArrowIcon;
      var flickityOptions = {
        autoPlay: 0,
        adaptiveHeight: true,
      ...
      for (var i = 0; i < this.slideShowsEls.length; i += 1) {
        var slideShow = new (js_default())(this.slideShowsEls[i], flickityOptions);
        slideShow.resize();
...
var Blog = /*#__PURE__*/function () {
  ...
  StaticBlog_createClass(Blog, [{
    ...
    value: function _blogMasonry() {
      // Set up masonry grid
      this.grid = new (masonry_default())(this.blogMasonry, {
        itemSelector: this.itemSelector,
        columnWidth: this.columnWidth,
        gutter: this.gutter,
        percentPosition: true
      });
      this._layoutGrid = this.grid.layout.bind(this.grid);
...
var Password = /*#__PURE__*/function () {
  ...
  Password_createClass(Password, [{
    ...
    value: function _openModal() {
      new (dist_default())(this.modalOptions).open(this.modalContents);
    }
  }, {
    key: "_centerModal",
    value: function _centerModal($modal) {
  ...
  Sidebar_createClass(Sidebar, [{
    ...
    value: function _bindEvents() {
      ...
      this.$body.on('click', '.navigation-parent-link', function (event) {
        ...
        $link.ariaExpanded(!_this._isExpanded($link));
...
var StaticHeader = /*#__PURE__*/function () {
  function StaticHeader(section) {
    ...
    var currencyDisclosureEls = section.el.querySelectorAll('[data-disclosure-currency]');
    var localeDisclosureEls = section.el.querySelectorAll('[data-disclosure-locale]');
    this.currencyDisclosures = [];
    this.localeDisclosures = [];

    if (currencyDisclosureEls.length) {
      for (var i = 0; i < currencyDisclosureEls.length; i++) {
        this.currencyDisclosures.push(new shopify_cross_border_dist_index_es(currencyDisclosureEls[i]));
      }
    }

    if (localeDisclosureEls.length) {
      for (var _i = 0; _i < localeDisclosureEls.length; _i++) {
        this.localeDisclosures.push(new shopify_cross_border_dist_index_es(localeDisclosureEls[_i]));
      }
    }
  }
  ...
  StaticHeader_createClass(StaticHeader, [{
    key: "onSectionUnload",
    value: function onSectionUnload() {
      this.currencyDisclosures.forEach(function (currencyDisclosure) {
        return currencyDisclosure.unload();
      });
      this.localeDisclosures.forEach(function (localeDisclosure) {
        return localeDisclosure.unload();
      });
    }
  }]);
...
var Vogue = /*#__PURE__*/function () {
  ...
  Vogue_createClass(Vogue, [{
    ...
    value: function _init() {
      ...
      this.rte = new RTE(); // Page Templates
...
/******/ })()
;
//# sourceMappingURL=vogue.js.map?1624644853845